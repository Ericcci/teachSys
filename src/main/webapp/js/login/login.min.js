var Login = function () {
    var e = function () {
        ...
        function e(e) {
            ...
            var r = $('<span><img src="../image/flags/' + e.element.value.toLowerCase() + '.png" class="img-flag" /> ' + e.text + "</span>");
            return r
        }
    ...
    return {
        init: function () {
            e(), r(), s(), $.backstretch(["../image/1.jpg", "../image/2.jpg", "../image/3.jpg", "../image/4.jpg"], {
                fade: 1e3,
                duration: 8e3
            })
        }
