...
<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="index.html">
                <img src="../image/logo-light.png" alt="logo" class="logo-default"/> </a>
                    ...
                    <li class="dropdown dropdown-user dropdown-dark">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                           data-close-others="true">
                            ...
                            <img alt="" class="img-circle" src="../image/avatar9.jpg"/> </a>
...
<script src="../js/common/quick-sidebar.min.js" type="text/javascript"></script>
<script src="../js/common/quick-nav.js" type="text/javascript"></script>
